...
class Machine(models.Model):
    ...
    model = models.ForeignKey(MachineModel, on_delete=models.PROTECT, related_name="machines")
    ...
    def __str__(self):
        return f"{self.model.name} ({self.serial or 's/serial'})"
...
class Manual(models.Model):
    ...
    url = models.URLField(blank=True)  # se quiser link do drive/youtube
    active = models.BooleanField(default=True)
...
class Part(models.Model):
    ...
    compatible_models = models.ManyToManyField(MachineModel, blank=True, related_name="compatible_parts")
